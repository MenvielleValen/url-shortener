  ...
  return (
    <footer className="absolute bottom-0 mt-6 mb-6 text-gray-500 left-0 right-0 px-4">
      <div className="flex justify-between w-full items-center">
        <p className="text-sm text-gray-400">Made by <Link className="text-indigo-300" href="https://portfolio-menviellevalen.vercel.app/">  Valentín</Link> | {new Date().getFullYear()}</p>
